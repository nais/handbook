...
!!! Critical
    Read through [privileges](technical/privileges) and ensure to understand both what user identity you are logging with, as well as what you might want to avoid doing with it or can do in another/better way.
